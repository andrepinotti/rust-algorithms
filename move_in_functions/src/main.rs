/*		[4.1. What is Ownership?]
	...
	Posso passar o Ownership de um valor como parãmetro de função ?
...
fn main() {
	...
	recebe_ownership(s  );	// Propriedade do 'String' entregue para a função
										// s não é mais válido
	// println!("{}", s );  -> não é valido

    //NOTE -> Para tornar o s válido basta colocarmos como clone o parâmetro de "recebe_ownership"
